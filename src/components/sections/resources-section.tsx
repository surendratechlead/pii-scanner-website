...
const COLOR_CLASSES: Record<string, { bg: string; text: string; border: string }> = {
  emerald: { bg: 'bg-emerald-100 dark:bg-emerald-950', text: 'text-emerald-600', border: 'group-hover:border-l-emerald-500' },
  teal: { bg: 'bg-teal-100 dark:bg-teal-950', text: 'text-teal-600', border: 'group-hover:border-l-teal-500' },
  cyan: { bg: 'bg-cyan-100 dark:bg-cyan-950', text: 'text-cyan-600', border: 'group-hover:border-l-cyan-500' },
  violet: { bg: 'bg-violet-100 dark:bg-violet-950', text: 'text-violet-600', border: 'group-hover:border-l-violet-500' },
  amber: { bg: 'bg-amber-100 dark:bg-amber-950', text: 'text-amber-600', border: 'group-hover:border-l-amber-500' },
  rose: { bg: 'bg-rose-100 dark:bg-rose-950', text: 'text-rose-600', border: 'group-hover:border-l-rose-500' },
  blue: { bg: 'bg-blue-100 dark:bg-blue-950', text: 'text-blue-600', border: 'group-hover:border-l-blue-500' },
}
            ...
            return (
              <MotionItem key={i} variants={fadeInUp}>
                <a href={resource.href} className="group block h-full">
                  <Card className={`h-full border-2 border-l-4 border-l-transparent ${colors.border} hover:shadow-xl hover:-translate-y-1 transition-all duration-300`}>
