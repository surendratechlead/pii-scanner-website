  ...
  return (
    <section id="ai-detection" className="py-16 md:py-24">
      <div className="container mx-auto px-4">
        ...
        {/* Scan Mode Cards */}
        <div className="grid md:grid-cols-3 gap-4 md:gap-6 max-w-6xl mx-auto mb-12 md:mb-16">
          {SCAN_MODES.map((mode, i) => (
            <Card key={i} className={`relative overflow-hidden ${i === 2 ? 'border-violet-500 border-2' : 'border-border'}`}>
              {i === 2 && (
        ...
        <div className="max-w-3xl mx-auto mb-12 md:mb-16">
          ...
          <div className="grid grid-cols-3 gap-3 md:gap-4">
            {LLM_PROVIDERS.map((provider, i) => (
              <div key={i} className="bg-card border border-border rounded-lg p-3 md:p-4 text-center">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
            {PII_TYPES.map((category, i) => (
              <div key={i} className="bg-card border border-border rounded-lg p-3 md:p-4">
