        ...
        <div className="max-w-5xl mx-auto mb-12 md:mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
            {EXPERTISE.map((item, i) => (
              <Card key={i} className="border-2 hover:border-emerald-300 dark:hover:border-emerald-700 transition-colors">
        ...
        <div className="max-w-5xl mx-auto mb-12 md:mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            {CAPABILITIES.map((cap, i) => (
              <Card key={i} className="group border-2 hover:border-emerald-300 dark:hover:border-emerald-700 hover:shadow-lg transition-all duration-300">
